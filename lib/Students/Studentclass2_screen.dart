...
class Class2HomeScreen extends StatefulWidget {
  @override
  _Class2HomeScreenState createState() => _Class2HomeScreenState();
}

class _Class2HomeScreenState extends State<Class2HomeScreen> {
  String studentName = "";
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Class III BCA "B"', style: TextStyle(color: Colors.white)),
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildGridItem(Icons.people, "Faculty List", () {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FacultyListScreen(className: "BCA III 'B'"),
            ));
          }),
