...
class Class8HomeScreen extends StatefulWidget {
  @override
  _Class8HomeScreenState createState() => _Class8HomeScreenState();
}

class _Class8HomeScreenState extends State<Class8HomeScreen> {
  String studentName = "";
  String className = "BCA I 'C'";
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Class I BCA "C"', style: TextStyle(color: Colors.white)),
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildGridItem(Icons.people, "Faculty List", () {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FacultyListScreen(className: "BCA I 'C'"),
            ));
          }),
