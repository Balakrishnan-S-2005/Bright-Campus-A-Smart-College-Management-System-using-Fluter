...
class Class6HomeScreen extends StatefulWidget {
  @override
  _Class6HomeScreenState createState() => _Class6HomeScreenState();
}

class _Class6HomeScreenState extends State<Class6HomeScreen> {
  String studentName = "";
  String className = "BCA I 'A'";
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Class I BCA "A"', style: TextStyle(color: Colors.white)),
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildGridItem(Icons.people, "Faculty List", () {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FacultyListScreen(className: "BCA I 'A'"),
            ));
          }),
