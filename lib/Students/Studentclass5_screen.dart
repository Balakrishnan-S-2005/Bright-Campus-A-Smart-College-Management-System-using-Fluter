...
class Class5HomeScreen extends StatefulWidget {
  @override
  _Class5HomeScreenState createState() => _Class5HomeScreenState();
}

class _Class5HomeScreenState extends State<Class5HomeScreen> {
  String studentName = "";
  String className = "BCA II 'C'";
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Class II BCA "C"', style: TextStyle(color: Colors.white)),
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildGridItem(Icons.people, "Faculty List", () {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FacultyListScreen(className: "BCA II 'C'"),
            ));
          }),
