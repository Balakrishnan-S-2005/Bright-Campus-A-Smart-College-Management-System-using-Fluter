...
class Class3HomeScreen extends StatefulWidget {
  @override
  _Class3HomeScreenState createState() => _Class3HomeScreenState();
}

class _Class3HomeScreenState extends State<Class3HomeScreen> {
  String studentName = "";
  String className = "BCA III 'B'";
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Class II BCA "A"', style: TextStyle(color: Colors.white)),
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildGridItem(Icons.people, "Faculty List", () {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FacultyListScreen(className: "BCA II 'A'"),
            ));
          }),
          _buildGridItem(Icons.payment, "Fees Structure", () {
            Navigator.push(context, MaterialPageRoute(
