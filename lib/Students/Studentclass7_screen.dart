...
class Class7HomeScreen extends StatefulWidget {
  @override
  _Class7HomeScreenState createState() => _Class7HomeScreenState();
}

class _Class7HomeScreenState extends State<Class7HomeScreen> {
  String studentName = "";
  String className = "BCA I 'B'";
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Class I BCA "B"', style: TextStyle(color: Colors.white)),
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _buildGridItem(Icons.people, "Faculty List", () {
            Navigator.push(context, MaterialPageRoute(
              builder: (context) => FacultyListScreen(className: "BCA I 'B'"),
            ));
          }),
